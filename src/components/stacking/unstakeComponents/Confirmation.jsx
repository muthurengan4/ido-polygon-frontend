...
const Confirmation = (props) => {
  ...
  const handleUnstakeTokens = () => {
    unstakeToken(unstakeAmount);
  };

  return (
    <>
      <div className="stack-tab confirmation">
        {unstakeLoading.isActive ? (
          <>
            {unstakeLoading.status ? (
              <>
                <h4 className="text-center text-capitalize letter-3">
                  {unstakeLoading.buttonContent}
                </h4>
                ...
                <p className="text-center">
                  You have intitated unstaking request please check metamask/walletconnect
                </p>
              </>
            ) : unstakeLoading.acceptStatus ? (
              <>
                <h4 className="text-center text-capitalize letter-3">
                  Confirmed
                </h4>
                ...
                <p className="text-center mb-0">
                  You have initiated the unstaking process and started the 7day
                  timer.
                </p>
                <p className="text-center">
              ...
              <>
                ...
                <p className="text-center mb-0">
                  You have rejected the unstaking request.
                </p>
                <div className="text-center">
                  <button
          ...
          <>
            ...
            <p className="text-center">
              Check the details that are provided and confirm unstaking
            </p>
            <div className="text-center">
              <button
                className="btn btn--small btn--primary text-capitalize"
